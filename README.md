...
If you are getting this error while building on Visual Studio:
     ...
     ```
That's because for some reason vcpkg.cmake is linking libprotobuf.dll instead of libprotobuf.lib. To fix this just go to Properties > Linker > Input > Additional Dependencies and change the C:\vcpkg\installed\x64-windows\debug\bin\libprotobufd.dll to C:\vcpkg\installed\x64-windows\debug\lib\protobufd.lib
